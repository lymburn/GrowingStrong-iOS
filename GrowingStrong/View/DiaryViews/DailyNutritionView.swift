...
extension DailyNutritionView {
    ...
    fileprivate func setupConstraints() {
        ...
        caloriesLabel.widthAnchor.constraint(equalToConstant: Constants.ScreenSize.width * 0.6).isActive = true
        ...
        carbsLabel.widthAnchor.constraint(equalToConstant: Constants.ScreenSize.width * 0.6).isActive = true
        ...
        fatLabel.widthAnchor.constraint(equalToConstant: Constants.ScreenSize.width * 0.6).isActive = true
        ...
        proteinLabel.widthAnchor.constraint(equalToConstant: Constants.ScreenSize.width * 0.6).isActive = true
